...
<head>
    <title>Downtown Menu | Upper Crust Pizza 🍕</title>
...
<body onload="createCaptcha();">
    <div class="wrapper">
        ...
        <section class="bgInner">
            <div class="contianer">
                <h1 class="heading fontHeading fontWeight600 text-uppercase text-center text_primary">Downtown Menu</h1>
        ...
        <section class="bgLocation5">
            <div class="container">
                ...
                <hr>
                <p class="fontWeight600 mt-lg-5  mt-4 small_heading fontHeading ps-lg-3">MONDAY - FRIDAY 11AM-1PM</p>
