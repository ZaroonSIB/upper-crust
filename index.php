...
<body onload="createCaptcha();">
   <div class="wrapper">
      ...
      <section class="bgLocation1 pt-lg-5">
         <div class="container">
            <div class="text-center bannerBottom">
      ...
      <section class="bgLocation3 bgSection">
         <div class="container">
      ...
      <section class="bgPrimary py-0 pizzaSlice">
      ...
      <section class="bgSection bgLocation">
      ...
      <section class="py-lg-3">
         <div class="container-fluid">
            <img src="images/banner/bottom.jpg" class="w-100" alt="">
         </div>
      </section>
   </div>
